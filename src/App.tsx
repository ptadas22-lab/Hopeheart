...
const MOOD_CONFIGS: MoodConfig[] = [
  ...
  { id: 'lonely', label: 'Lonely', emoji: '💙', color: 'text-blue-500', accentBg: '#F1F6FE', bgLight: 'bg-[#F1F6FE]', buddyExpression: 'lonely', tagline: 'An empty seat. Wishing for a kindred spark.' },
